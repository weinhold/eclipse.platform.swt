...
void createHandle (int index) {
	...
	handle = HaikuToolBar.create(display.getDisplayHandle(), horizontal);
...
public int getItemCount () {
	checkWidget();
	return HaikuToolBar.getItemCount(handle);
}
...
ToolItem [] _getItems () {
	long[] /*int[]*/ itemHandles = HaikuToolBar.getItems(handle);
