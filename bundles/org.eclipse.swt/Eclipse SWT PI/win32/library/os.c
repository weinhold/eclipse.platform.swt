...
#ifndef NO_VtblCall__IIJIJ_3I
JNIEXPORT jint JNICALL OS_NATIVE(VtblCall__IIJIJ_3I)
	(JNIEnv *env, jclass that, jint arg0, jint arg1, jlong arg2, jint arg3, jlong arg4, jintArray arg5)
{
	jint *lparg5=NULL;
	jint rc = 0;
	OS_NATIVE_ENTER(env, that, VtblCall__IIJIJ_3I_FUNC);
	if (arg5) if ((lparg5 = (*env)->GetIntArrayElements(env, arg5, NULL)) == NULL) goto fail;
	rc = (jint)((jint (STDMETHODCALLTYPE *)(jint, jlong, jint, jlong, jint *))(*(jint **)arg1)[arg0])(arg1, arg2, arg3, arg4, lparg5);
fail:
	if (arg5 && lparg5) (*env)->ReleaseIntArrayElements(env, arg5, lparg5, 0);
	OS_NATIVE_EXIT(env, that, VtblCall__IIJIJ_3I_FUNC);
	return rc;
}
#endif
