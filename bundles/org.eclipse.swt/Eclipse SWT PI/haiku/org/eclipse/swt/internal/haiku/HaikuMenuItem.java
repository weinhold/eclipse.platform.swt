...
public class HaikuMenuItem {
	...
	public static native long /*int*/ createSeparatorItem(long /*int*/ displayHandle, boolean horizontal);

	public static native boolean isSelected(long /*int*/ handle);

	public static native void setAccelerator(long /*int*/ handle, int accelerator);
	...
	public static native void setSubMenu(long /*int*/ handle, long /*int*/ subMenuHandle);
