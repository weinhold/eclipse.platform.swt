...
public class HaikuMenu {
	public static native long /*int*/ createDropDownMenu(long /*int*/ displayHandle);

	public static native long /*int*/ createMenuBar(long /*int*/ displayHandle);

	public static native long /*int*/ createPopUpMenu(long /*int*/ displayHandle);
	...
	public static native boolean isVisible(long /*int*/ handle);
