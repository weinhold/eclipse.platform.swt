...
public static final int sel_duration_1 = sel_registerName("duration:");
...
public static final int sel_fromValue = sel_registerName("fromValue");
public static final int sel_setFromValue_1 = sel_registerName("setFromValue:");
public static final int sel_toValue = sel_registerName("toValue");
...
/** Classes */
public static final int class_CATiledLayer = objc_getClass("CATiledLayer");
public static final int class_CATextLayer = objc_getClass("CATextLayer");
public static final int class_CARenderer = objc_getClass("CARenderer");
public static final int class_CIFilterGenerator = objc_getClass("CIFilterGenerator");
public static final int class_CAKeyframeAnimation = objc_getClass("CAKeyframeAnimation");
public static final int class_CAOpenGLLayer = objc_getClass("CAOpenGLLayer");
public static final int class_CAConstraintLayoutManager = objc_getClass("CAConstraintLayoutManager");
public static final int class_CIFilter = objc_getClass("CIFilter");
public static final int class_CAPropertyAnimation = objc_getClass("CAPropertyAnimation");
public static final int class_CAAnimation = objc_getClass("CAAnimation");
public static final int class_CABasicAnimation = objc_getClass("CABasicAnimation");
public static final int class_CIPlugIn = objc_getClass("CIPlugIn");
public static final int class_CAMediaTimingFunction = objc_getClass("CAMediaTimingFunction");
public static final int class_CALayer = objc_getClass("CALayer");
public static final int class_CISampler = objc_getClass("CISampler");
public static final int class_CIFilterShape = objc_getClass("CIFilterShape");
public static final int class_CIContext = objc_getClass("CIContext");
public static final int class_CIImageAccumulator = objc_getClass("CIImageAccumulator");
public static final int class_CIVector = objc_getClass("CIVector");
public static final int class_CIKernel = objc_getClass("CIKernel");
public static final int class_CAConstraint = objc_getClass("CAConstraint");
public static final int class_CATransaction = objc_getClass("CATransaction");
public static final int class_CAScrollLayer = objc_getClass("CAScrollLayer");
public static final int class_CATransition = objc_getClass("CATransition");

/** Selectors */
public static final int sel_addUpdateRect_1 = sel_registerName("addUpdateRect:");
public static final int sel_setAffineTransform_1 = sel_registerName("setAffineTransform:");
public static final int sel_animation = sel_registerName("animation");
public static final int sel_isCumulative = sel_registerName("isCumulative");
public static final int sel_renderInContext_1 = sel_registerName("renderInContext:");
public static final int sel_imageWithColor_1 = sel_registerName("imageWithColor:");
public static final int sel_imageWithCGLayer_1 = sel_registerName("imageWithCGLayer:");
public static final int sel_copyCGLPixelFormatForDisplayMask_1 = sel_registerName("copyCGLPixelFormatForDisplayMask:");
public static final int sel_drawLayer_1inContext_1 = sel_registerName("drawLayer:inContext:");
public static final int sel_fadeDuration = sel_registerName("fadeDuration");
public static final int sel_localizedDescriptionForFilterName_1 = sel_registerName("localizedDescriptionForFilterName:");
public static final int sel_isDoubleSided = sel_registerName("isDoubleSided");
public static final int sel_setLevelsOfDetailBias_1 = sel_registerName("setLevelsOfDetailBias:");
public static final int sel_clear = sel_registerName("clear");
public static final int sel_blue = sel_registerName("blue");
public static final int sel_setAsynchronous_1 = sel_registerName("setAsynchronous:");
public static final int sel_setLevelsOfDetail_1 = sel_registerName("setLevelsOfDetail:");
public static final int sel_registerFilterName_1 = sel_registerName("registerFilterName:");
public static final int sel_functionWithControlPoints_1_1_1_1 = sel_registerName("functionWithControlPoints::::");
public static final int sel_setPosition_1 = sel_registerName("setPosition:");
public static final int sel_initWithLayer_1 = sel_registerName("initWithLayer:");
public static final int sel_imageWithData_1options_1 = sel_registerName("imageWithData:options:");
public static final int sel_colorWithRed_1green_1blue_1 = sel_registerName("colorWithRed:green:blue:");
public static final int sel_repeatDuration = sel_registerName("repeatDuration");
public static final int sel_endFrame = sel_registerName("endFrame");
public static final int sel_isAsynchronous = sel_registerName("isAsynchronous");
public static final int sel_stringRepresentation = sel_registerName("stringRepresentation");
public static final int sel_emptyImage = sel_registerName("emptyImage");
public static final int sel_colorWithCGColor_1 = sel_registerName("colorWithCGColor:");
public static final int sel_drawInContext_1 = sel_registerName("drawInContext:");
public static final int sel_releaseCGLContext_1 = sel_registerName("releaseCGLContext:");
public static final int sel_isRemovedOnCompletion = sel_registerName("isRemovedOnCompletion");
public static final int sel_commit = sel_registerName("commit");
public static final int sel_initWithImageProvider_1size_1_1format_1colorSpace_1options_1 = sel_registerName("initWithImageProvider:size::format:colorSpace:options:");
public static final int sel_setContents_1 = sel_registerName("setContents:");
public static final int sel_animationDidStop_1finished_1 = sel_registerName("animationDidStop:finished:");
public static final int sel_speed = sel_registerName("speed");
public static final int sel_insertSublayer_1above_1 = sel_registerName("insertSublayer:above:");
public static final int sel_W = sel_registerName("W");
public static final int sel_localizedNameForCategory_1 = sel_registerName("localizedNameForCategory:");
public static final int sel_filterWithImageURL_1options_1 = sel_registerName("filterWithImageURL:options:");
public static final int sel_filter = sel_registerName("filter");
public static final int sel_convertPoint_1toLayer_1 = sel_registerName("convertPoint:toLayer:");
public static final int sel_beginFrameAtTime_1timeStamp_1 = sel_registerName("beginFrameAtTime:timeStamp:");
public static final int sel_provideImageData_1bytesPerRow_1origin_1_1size_1_1userInfo_1 = sel_registerName("provideImageData:bytesPerRow:origin::size::userInfo:");
public static final int sel_X = sel_registerName("X");
public static final int sel_constraintWithAttribute_1relativeTo_1attribute_1 = sel_registerName("constraintWithAttribute:relativeTo:attribute:");
public static final int sel_createCGImage_1fromRect_1 = sel_registerName("createCGImage:fromRect:");
public static final int sel_red = sel_registerName("red");
public static final int sel_filterGeneratorWithContentsOfURL_1 = sel_registerName("filterGeneratorWithContentsOfURL:");
public static final int sel_imageAccumulatorWithExtent_1format_1 = sel_registerName("imageAccumulatorWithExtent:format:");
public static final int sel_initWithTexture_1size_1flipped_1colorSpace_1 = sel_registerName("initWithTexture:size:flipped:colorSpace:");
public static final int sel_vectorWithX_1 = sel_registerName("vectorWithX:");
public static final int sel_opacity = sel_registerName("opacity");
public static final int sel_definition = sel_registerName("definition");
public static final int sel_imageWithBitmapData_1bytesPerRow_1size_1format_1colorSpace_1 = sel_registerName("imageWithBitmapData:bytesPerRow:size:format:colorSpace:");
public static final int sel_samplerWithImage_1options_1 = sel_registerName("samplerWithImage:options:");
public static final int sel_setROISelector_1 = sel_registerName("setROISelector:");
public static final int sel_drawImage_1inRect_1fromRect_1 = sel_registerName("drawImage:inRect:fromRect:");
public static final int sel_vectorWithString_1 = sel_registerName("vectorWithString:");
public static final int sel_loadNonExecutablePlugIns = sel_registerName("loadNonExecutablePlugIns");
public static final int sel_filterWithImageData_1options_1 = sel_registerName("filterWithImageData:options:");
public static final int sel_imageWithData_1 = sel_registerName("imageWithData:");
public static final int sel_exportedKeys = sel_registerName("exportedKeys");
public static final int sel_actionForLayer_1forKey_1 = sel_registerName("actionForLayer:forKey:");
public static final int sel_render = sel_registerName("render");
public static final int sel_apply_1 = sel_registerName("apply:");
public static final int sel_imageWithImageProvider_1size_1_1format_1colorSpace_1options_1 = sel_registerName("imageWithImageProvider:size::format:colorSpace:options:");
public static final int sel_removeExportedKey_1 = sel_registerName("removeExportedKey:");
public static final int sel_shapeWithRect_1 = sel_registerName("shapeWithRect:");
public static final int sel_drawInCGLContext_1pixelFormat_1forLayerTime_1displayTime_1 = sel_registerName("drawInCGLContext:pixelFormat:forLayerTime:displayTime:");
public static final int sel_contents = sel_registerName("contents");
public static final int sel_addAnimation_1forKey_1 = sel_registerName("addAnimation:forKey:");
public static final int sel_vectorWithX_1Y_1Z_1W_1 = sel_registerName("vectorWithX:Y:Z:W:");
public static final int sel_addSublayer_1 = sel_registerName("addSublayer:");
public static final int sel_initWithControlPoints_1_1_1_1 = sel_registerName("initWithControlPoints::::");
public static final int sel_imageWithContentsOfURL_1 = sel_registerName("imageWithContentsOfURL:");
public static final int sel_setSublayerTransform_1 = sel_registerName("setSublayerTransform:");
public static final int sel_filterNamesInCategories_1 = sel_registerName("filterNamesInCategories:");
public static final int sel_intersectWithRect_1 = sel_registerName("intersectWithRect:");
public static final int sel_exportKey_1fromObject_1withName_1 = sel_registerName("exportKey:fromObject:withName:");
public static final int sel_insertSublayer_1below_1 = sel_registerName("insertSublayer:below:");
public static final int sel_createCGLayerWithSize_1info_1 = sel_registerName("createCGLayerWithSize:info:");
public static final int sel_initWithAttribute_1relativeTo_1attribute_1scale_1offset_1 = sel_registerName("initWithAttribute:relativeTo:attribute:scale:offset:");
public static final int sel_canDrawInCGLContext_1pixelFormat_1forLayerTime_1displayTime_1 = sel_registerName("canDrawInCGLContext:pixelFormat:forLayerTime:displayTime:");
public static final int sel_actionForKey_1 = sel_registerName("actionForKey:");
public static final int sel_preferredSizeOfLayer_1 = sel_registerName("preferredSizeOfLayer:");
public static final int sel_convertRect_1toLayer_1 = sel_registerName("convertRect:toLayer:");
public static final int sel_setSpeed_1 = sel_registerName("setSpeed:");
public static final int sel_initWithCGLayer_1 = sel_registerName("initWithCGLayer:");
public static final int sel_setFilter_1 = sel_registerName("setFilter:");
public static final int sel_contextWithCGContext_1options_1 = sel_registerName("contextWithCGContext:options:");
public static final int sel_displayLayer_1 = sel_registerName("displayLayer:");
public static final int sel_loadAllPlugIns = sel_registerName("loadAllPlugIns");
public static final int sel_shouldArchiveValueForKey_1 = sel_registerName("shouldArchiveValueForKey:");
public static final int sel_filterNamesInCategory_1 = sel_registerName("filterNamesInCategory:");
public static final int sel_imageWithTexture_1size_1flipped_1colorSpace_1 = sel_registerName("imageWithTexture:size:flipped:colorSpace:");
public static final int sel_imageWithCGImage_1 = sel_registerName("imageWithCGImage:");
public static final int sel_imageWithCVImageBuffer_1 = sel_registerName("imageWithCVImageBuffer:");
public static final int sel_unionWithRect_1 = sel_registerName("unionWithRect:");
public static final int sel_animationWithKeyPath_1 = sel_registerName("animationWithKeyPath:");
public static final int sel_contentsRect = sel_registerName("contentsRect");
public static final int sel_setContentsRect_1 = sel_registerName("setContentsRect:");
public static final int sel_functionWithName_1 = sel_registerName("functionWithName:");
public static final int sel_load_1 = sel_registerName("load:");
public static final int sel_setRepeatCount_1 = sel_registerName("setRepeatCount:");
public static final int sel_samplerWithImage_1keysAndValues_1 = sel_registerName("samplerWithImage:keysAndValues:");
public static final int sel_copyCGLContextForPixelFormat_1 = sel_registerName("copyCGLContextForPixelFormat:");
public static final int sel_layoutSublayers = sel_registerName("layoutSublayers");
public static final int sel_drawImage_1atPoint_1fromRect_1 = sel_registerName("drawImage:atPoint:fromRect:");
public static final int sel_convertTime_1fromLayer_1 = sel_registerName("convertTime:fromLayer:");
public static final int sel_removeAllAnimations = sel_registerName("removeAllAnimations");
public static final int sel_scrollToRect_1 = sel_registerName("scrollToRect:");
public static final int sel_setMasksToBounds_1 = sel_registerName("setMasksToBounds:");
public static final int sel_classAttributes = sel_registerName("classAttributes");
public static final int sel_insertSublayer_1atIndex_1 = sel_registerName("insertSublayer:atIndex:");
public static final int sel_setEdgeAntialiasingMask_1 = sel_registerName("setEdgeAntialiasingMask:");
public static final int sel_resizeSublayersWithOldSize_1 = sel_registerName("resizeSublayersWithOldSize:");
public static final int sel_replaceSublayer_1with_1 = sel_registerName("replaceSublayer:with:");
public static final int sel_initWithImage_1 = sel_registerName("initWithImage:");
public static final int sel_initWithExtent_1format_1 = sel_registerName("initWithExtent:format:");
public static final int sel_begin = sel_registerName("begin");
public static final int sel_initWithX_1 = sel_registerName("initWithX:");
public static final int sel_timeOffset = sel_registerName("timeOffset");
public static final int sel_imageByCroppingToRect_1 = sel_registerName("imageByCroppingToRect:");
public static final int sel_disconnectObject_1withKey_1toObject_1withKey_1 = sel_registerName("disconnectObject:withKey:toObject:withKey:");
public static final int sel_setWrapped_1 = sel_registerName("setWrapped:");
public static final int sel_setDoubleSided_1 = sel_registerName("setDoubleSided:");
public static final int sel_localizedNameForFilterName_1 = sel_registerName("localizedNameForFilterName:");
public static final int sel_beginTime = sel_registerName("beginTime");
public static final int sel_imageWithCGLayer_1options_1 = sel_registerName("imageWithCGLayer:options:");
public static final int sel_constraintWithAttribute_1relativeTo_1attribute_1scale_1offset_1 = sel_registerName("constraintWithAttribute:relativeTo:attribute:scale:offset:");
public static final int sel_samplerWithImage_1 = sel_registerName("samplerWithImage:");
public static final int sel_constraintWithAttribute_1relativeTo_1attribute_1offset_1 = sel_registerName("constraintWithAttribute:relativeTo:attribute:offset:");
public static final int sel_defaultActionForKey_1 = sel_registerName("defaultActionForKey:");
public static final int sel_setBeginTime_1 = sel_registerName("setBeginTime:");
public static final int sel_setDefaults = sel_registerName("setDefaults");
public static final int sel_localizedReferenceDocumentationForFilterName_1 = sel_registerName("localizedReferenceDocumentationForFilterName:");
public static final int sel_setOpacity_1 = sel_registerName("setOpacity:");
public static final int sel_setAttributes_1forExportedKey_1 = sel_registerName("setAttributes:forExportedKey:");
public static final int sel_connectObject_1withKey_1toObject_1withKey_1 = sel_registerName("connectObject:withKey:toObject:withKey:");
public static final int sel_modelLayer = sel_registerName("modelLayer");
public static final int sel_initWithX_1Y_1Z_1 = sel_registerName("initWithX:Y:Z:");
public static final int sel_green = sel_registerName("green");
public static final int sel_initWithX_1Y_1Z_1W_1 = sel_registerName("initWithX:Y:Z:W:");
public static final int sel_affineTransform = sel_registerName("affineTransform");
public static final int sel_setRepeatDuration_1 = sel_registerName("setRepeatDuration:");
public static final int sel_levelsOfDetail = sel_registerName("levelsOfDetail");
public static final int sel_inputKeys = sel_registerName("inputKeys");
public static final int sel_needsDisplayOnBoundsChange = sel_registerName("needsDisplayOnBoundsChange");
public static final int sel_invalidateLayoutOfLayer_1 = sel_registerName("invalidateLayoutOfLayer:");
public static final int sel_isAdditive = sel_registerName("isAdditive");
public static final int sel_colorWithRed_1green_1blue_1alpha_1 = sel_registerName("colorWithRed:green:blue:alpha:");
public static final int sel_setAnchorPoint_1 = sel_registerName("setAnchorPoint:");
public static final int sel_nextFrameTime = sel_registerName("nextFrameTime");
public static final int sel_extent = sel_registerName("extent");
public static final int sel_edgeAntialiasingMask = sel_registerName("edgeAntialiasingMask");
public static final int sel_reclaimResources = sel_registerName("reclaimResources");
public static final int sel_runActionForKey_1object_1arguments_1 = sel_registerName("runActionForKey:object:arguments:");
public static final int sel_initWithCVImageBuffer_1 = sel_registerName("initWithCVImageBuffer:");
public static final int sel_flush = sel_registerName("flush");
public static final int sel_vectorWithX_1Y_1Z_1 = sel_registerName("vectorWithX:Y:Z:");
public static final int sel_setNeedsLayout = sel_registerName("setNeedsLayout");
public static final int sel_colorWithString_1 = sel_registerName("colorWithString:");
public static final int sel_vectorWithValues_1count_1 = sel_registerName("vectorWithValues:count:");
public static final int sel_setAdditive_1 = sel_registerName("setAdditive:");
public static final int sel_addConstraint_1 = sel_registerName("addConstraint:");
public static final int sel_updateBounds = sel_registerName("updateBounds");
public static final int sel_isWrapped = sel_registerName("isWrapped");
public static final int sel_initWithX_1Y_1 = sel_registerName("initWithX:Y:");
public static final int sel_initWithCGImage_1options_1 = sel_registerName("initWithCGImage:options:");
public static final int sel_resizeWithOldSuperlayerSize_1 = sel_registerName("resizeWithOldSuperlayerSize:");
public static final int sel_imageWithCGImage_1options_1 = sel_registerName("imageWithCGImage:options:");
public static final int sel_layoutSublayersOfLayer_1 = sel_registerName("layoutSublayersOfLayer:");
public static final int sel_initWithRect_1 = sel_registerName("initWithRect:");
public static final int sel_outputKeys = sel_registerName("outputKeys");
public static final int sel_setRemovedOnCompletion_1 = sel_registerName("setRemovedOnCompletion:");
public static final int sel_filterWithName_1keysAndValues_1 = sel_registerName("filterWithName:keysAndValues:");
public static final int sel_anchorPoint = sel_registerName("anchorPoint");
public static final int sel_setAutoreverses_1 = sel_registerName("setAutoreverses:");
public static final int sel_setImage_1dirtyRect_1 = sel_registerName("setImage:dirtyRect:");
public static final int sel_removeAnimationForKey_1 = sel_registerName("removeAnimationForKey:");
public static final int sel_defaultValueForKey_1 = sel_registerName("defaultValueForKey:");
public static final int sel_initWithImage_1options_1 = sel_registerName("initWithImage:options:");
public static final int sel_rendererWithCGLContext_1options_1 = sel_registerName("rendererWithCGLContext:options:");
public static final int sel_imageWithContentsOfURL_1options_1 = sel_registerName("imageWithContentsOfURL:options:");
public static final int sel_convertTime_1toLayer_1 = sel_registerName("convertTime:toLayer:");
public static final int sel_filterWithName_1 = sel_registerName("filterWithName:");
public static final int sel_imageByApplyingTransform_1 = sel_registerName("imageByApplyingTransform:");
public static final int sel_intersectWith_1 = sel_registerName("intersectWith:");
public static final int sel_getControlPointAtIndex_1values_1 = sel_registerName("getControlPointAtIndex:values:");
public static final int sel_setClassAttributes_1 = sel_registerName("setClassAttributes:");
public static final int sel_kernelsWithString_1 = sel_registerName("kernelsWithString:");
public static final int sel_registerFilterName_1constructor_1classAttributes_1 = sel_registerName("registerFilterName:constructor:classAttributes:");
public static final int sel_presentationLayer = sel_registerName("presentationLayer");
public static final int sel_setTransform_1 = sel_registerName("setTransform:");
public static final int sel_convertRect_1fromLayer_1 = sel_registerName("convertRect:fromLayer:");
public static final int sel_setShadowOpacity_1 = sel_registerName("setShadowOpacity:");
public static final int sel_initWithCGLayer_1options_1 = sel_registerName("initWithCGLayer:options:");
public static final int sel_shadowOpacity = sel_registerName("shadowOpacity");
public static final int sel_autoreverses = sel_registerName("autoreverses");
public static final int sel_filterGenerator = sel_registerName("filterGenerator");
public static final int sel_levelsOfDetailBias = sel_registerName("levelsOfDetailBias");
public static final int sel_contextWithCGLContext_1pixelFormat_1options_1 = sel_registerName("contextWithCGLContext:pixelFormat:options:");
public static final int sel_valueAtIndex_1 = sel_registerName("valueAtIndex:");
public static final int sel_convertPoint_1fromLayer_1 = sel_registerName("convertPoint:fromLayer:");
public static final int sel_initWithCGColor_1 = sel_registerName("initWithCGColor:");
public static final int sel_initWithImage_1keysAndValues_1 = sel_registerName("initWithImage:keysAndValues:");
public static final int sel_sublayerTransform = sel_registerName("sublayerTransform");
public static final int sel_setTimeOffset_1 = sel_registerName("setTimeOffset:");
public static final int sel_render_1toBitmap_1rowBytes_1bounds_1format_1colorSpace_1 = sel_registerName("render:toBitmap:rowBytes:bounds:format:colorSpace:");
public static final int sel_initWithBitmapData_1bytesPerRow_1size_1format_1colorSpace_1 = sel_registerName("initWithBitmapData:bytesPerRow:size:format:colorSpace:");
public static final int sel_fontSize = sel_registerName("fontSize");
public static final int sel_apply_1arguments_1options_1 = sel_registerName("apply:arguments:options:");
public static final int sel_clearCaches = sel_registerName("clearCaches");
public static final int sel_setFontSize_1 = sel_registerName("setFontSize:");
public static final int sel_masksToBounds = sel_registerName("masksToBounds");
public static final int sel_insetByX_1Y_1 = sel_registerName("insetByX:Y:");
public static final int sel_tileSize = sel_registerName("tileSize");
public static final int sel_setShadowRadius_1 = sel_registerName("setShadowRadius:");
public static final int sel_removeFromSuperlayer = sel_registerName("removeFromSuperlayer");
public static final int sel_unionWith_1 = sel_registerName("unionWith:");
public static final int sel_initWithContentsOfURL_1options_1 = sel_registerName("initWithContentsOfURL:options:");
public static final int sel_setTileSize_1 = sel_registerName("setTileSize:");
public static final int sel_layoutIfNeeded = sel_registerName("layoutIfNeeded");
public static final int sel_vectorWithX_1Y_1 = sel_registerName("vectorWithX:Y:");
public static final int sel_loadPlugIn_1allowNonExecutable_1 = sel_registerName("loadPlugIn:allowNonExecutable:");
public static final int sel_initWithCVImageBuffer_1options_1 = sel_registerName("initWithCVImageBuffer:options:");
public static final int sel_Z = sel_registerName("Z");
public static final int sel_releaseCGLPixelFormat_1 = sel_registerName("releaseCGLPixelFormat:");
public static final int sel_shadowRadius = sel_registerName("shadowRadius");
public static final int sel_initWithData_1options_1 = sel_registerName("initWithData:options:");
public static final int sel_preferredFrameSize = sel_registerName("preferredFrameSize");
public static final int sel_repeatCount = sel_registerName("repeatCount");
public static final int sel_createCGImage_1fromRect_1format_1colorSpace_1 = sel_registerName("createCGImage:fromRect:format:colorSpace:");
public static final int sel_zPosition = sel_registerName("zPosition");
public static final int sel_setNeedsDisplayOnBoundsChange_1 = sel_registerName("setNeedsDisplayOnBoundsChange:");
public static final int sel_animationDidStart_1 = sel_registerName("animationDidStart:");
public static final int sel_setZPosition_1 = sel_registerName("setZPosition:");
public static final int sel_transformBy_1interior_1 = sel_registerName("transformBy:interior:");
public static final int sel_imageWithCVImageBuffer_1options_1 = sel_registerName("imageWithCVImageBuffer:options:");
public static final int sel_Y = sel_registerName("Y");
public static final int sel_setCumulative_1 = sel_registerName("setCumulative:");

/** Constants */
public static final int kCAConstraintHeight = 7;
public static final int kCAConstraintMaxX = 2;
public static final int kCAConstraintMaxY = 6;
public static final int kCAConstraintMidX = 1;
public static final int kCAConstraintMidY = 5;
public static final int kCAConstraintMinX = 0;
public static final int kCAConstraintMinY = 4;
public static final int kCAConstraintWidth = 3;
public static final int kCALayerBottomEdge = 4;
public static final int kCALayerHeightSizable = 16;
public static final int kCALayerLeftEdge = 1;
public static final int kCALayerMaxXMargin = 4;
public static final int kCALayerMaxYMargin = 32;
public static final int kCALayerMinXMargin = 1;
public static final int kCALayerMinYMargin = 8;
public static final int kCALayerNotSizable = 0;
public static final int kCALayerRightEdge = 2;
public static final int kCALayerTopEdge = 8;
public static final int kCALayerWidthSizable = 2;

/** Globals */
//public static final native int CATransform3DIdentity();
//public static final native int kCAAlignmentCenter();
//public static final native int kCAAlignmentJustified();
//public static final native int kCAAlignmentLeft();
//public static final native int kCAAlignmentNatural();
//public static final native int kCAAlignmentRight();
//public static final native int kCAAnimationDiscrete();
//public static final native int kCAAnimationLinear();
//public static final native int kCAAnimationPaced();
//public static final native int kCAAnimationRotateAuto();
//public static final native int kCAAnimationRotateAutoReverse();
//public static final native int kCAFillModeBackwards();
//public static final native int kCAFillModeBoth();
//public static final native int kCAFillModeForwards();
//public static final native int kCAFillModeRemoved();
//public static final native int kCAFilterLinear();
//public static final native int kCAFilterNearest();
//public static final native int kCAGravityBottom();
//public static final native int kCAGravityBottomLeft();
//public static final native int kCAGravityBottomRight();
//public static final native int kCAGravityCenter();
//public static final native int kCAGravityLeft();
//public static final native int kCAGravityResize();
//public static final native int kCAGravityResizeAspect();
//public static final native int kCAGravityResizeAspectFill();
//public static final native int kCAGravityRight();
//public static final native int kCAGravityTop();
//public static final native int kCAGravityTopLeft();
//public static final native int kCAGravityTopRight();
//public static final native int kCAMediaTimingFunctionEaseIn();
//public static final native int kCAMediaTimingFunctionEaseInEaseOut();
//public static final native int kCAMediaTimingFunctionEaseOut();
//public static final native int kCAMediaTimingFunctionLinear();
//public static final native int kCAOnOrderIn();
//public static final native int kCAOnOrderOut();
//public static final native int kCAScrollBoth();
//public static final native int kCAScrollHorizontally();
//public static final native int kCAScrollNone();
//public static final native int kCAScrollVertically();
//public static final native int kCATransactionAnimationDuration();
//public static final native int kCATransactionDisableActions();
//public static final native int kCATransition();
//public static final native int kCATransitionFade();
//public static final native int kCATransitionFromBottom();
//public static final native int kCATransitionFromLeft();
//public static final native int kCATransitionFromRight();
//public static final native int kCATransitionFromTop();
//public static final native int kCATransitionMoveIn();
//public static final native int kCATransitionPush();
//public static final native int kCATransitionReveal();
//public static final native int kCATruncationEnd();
//public static final native int kCATruncationMiddle();
//public static final native int kCATruncationNone();
//public static final native int kCATruncationStart();
//public static final native int kCIApplyOptionDefinition();
//public static final native int kCIApplyOptionExtent();
//public static final native int kCIApplyOptionUserInfo();
//public static final native int kCIAttributeClass();
//public static final native int kCIAttributeDefault();
//public static final native int kCIAttributeDescription();
//public static final native int kCIAttributeDisplayName();
//public static final native int kCIAttributeFilterCategories();
//public static final native int kCIAttributeFilterDisplayName();
//public static final native int kCIAttributeFilterName();
//public static final native int kCIAttributeIdentity();
//public static final native int kCIAttributeMax();
//public static final native int kCIAttributeMin();
//public static final native int kCIAttributeName();
//public static final native int kCIAttributeReferenceDocumentation();
//public static final native int kCIAttributeSliderMax();
//public static final native int kCIAttributeSliderMin();
//public static final native int kCIAttributeType();
//public static final native int kCIAttributeTypeAngle();
//public static final native int kCIAttributeTypeBoolean();
//public static final native int kCIAttributeTypeCount();
//public static final native int kCIAttributeTypeDistance();
//public static final native int kCIAttributeTypeGradient();
//public static final native int kCIAttributeTypeInteger();
//public static final native int kCIAttributeTypeOffset();
//public static final native int kCIAttributeTypeOpaqueColor();
//public static final native int kCIAttributeTypePosition();
//public static final native int kCIAttributeTypePosition3();
//public static final native int kCIAttributeTypeRectangle();
//public static final native int kCIAttributeTypeScalar();
//public static final native int kCIAttributeTypeTime();
//public static final native int kCICategoryBlur();
//public static final native int kCICategoryBuiltIn();
//public static final native int kCICategoryColorAdjustment();
//public static final native int kCICategoryColorEffect();
//public static final native int kCICategoryCompositeOperation();
//public static final native int kCICategoryDistortionEffect();
//public static final native int kCICategoryFilterGenerator();
//public static final native int kCICategoryGenerator();
//public static final native int kCICategoryGeometryAdjustment();
//public static final native int kCICategoryGradient();
//public static final native int kCICategoryHalftoneEffect();
//public static final native int kCICategoryHighDynamicRange();
//public static final native int kCICategoryInterlaced();
//public static final native int kCICategoryNonSquarePixels();
//public static final native int kCICategoryReduction();
//public static final native int kCICategorySharpen();
//public static final native int kCICategoryStillImage();
//public static final native int kCICategoryStylize();
//public static final native int kCICategoryTileEffect();
//public static final native int kCICategoryTransition();
//public static final native int kCICategoryVideo();
//public static final native int kCIContextOutputColorSpace();
//public static final native int kCIContextUseSoftwareRenderer();
//public static final native int kCIContextWorkingColorSpace();
//public static final native int kCIFilterGeneratorExportedKey();
//public static final native int kCIFilterGeneratorExportedKeyName();
//public static final native int kCIFilterGeneratorExportedKeyTargetObject();
//public static final native int kCIFormatARGB8();
//public static final native int kCIFormatRGBA16();
//public static final native int kCIFormatRGBAf();
//public static final native int kCIImageColorSpace();
//public static final native int kCIImageProviderTileSize();
//public static final native int kCIImageProviderUserInfo();
//public static final native int kCIInputAllowDraftModeKey();
//public static final native int kCIInputAngleKey();
//public static final native int kCIInputAspectRatioKey();
//public static final native int kCIInputBackgroundImageKey();
//public static final native int kCIInputBiasKey();
//public static final native int kCIInputBoostKey();
//public static final native int kCIInputBoostShadowAmountKey();
//public static final native int kCIInputBrightnessKey();
//public static final native int kCIInputCenterKey();
//public static final native int kCIInputColorKey();
//public static final native int kCIInputContrastKey();
//public static final native int kCIInputDecoderVersionKey();
//public static final native int kCIInputEVKey();
//public static final native int kCIInputEnableChromaticNoiseTrackingKey();
//public static final native int kCIInputEnableSharpeningKey();
//public static final native int kCIInputExtentKey();
//public static final native int kCIInputGradientImageKey();
//public static final native int kCIInputIgnoreImageOrientationKey();
//public static final native int kCIInputImageKey();
//public static final native int kCIInputImageOrientationKey();
//public static final native int kCIInputIntensityKey();
//public static final native int kCIInputMaskImageKey();
//public static final native int kCIInputNeutralChromaticityXKey();
//public static final native int kCIInputNeutralChromaticityYKey();
//public static final native int kCIInputNeutralLocationKey();
//public static final native int kCIInputNeutralTemperatureKey();
//public static final native int kCIInputNeutralTintKey();
//public static final native int kCIInputRadiusKey();
//public static final native int kCIInputRefractionKey();
//public static final native int kCIInputSaturationKey();
//public static final native int kCIInputScaleFactorKey();
//public static final native int kCIInputScaleKey();
//public static final native int kCIInputShadingImageKey();
//public static final native int kCIInputSharpnessKey();
//public static final native int kCIInputTargetImageKey();
//public static final native int kCIInputTimeKey();
//public static final native int kCIInputTransformKey();
//public static final native int kCIInputWidthKey();
//public static final native int kCIOutputImageKey();
//public static final native int kCISamplerAffineMatrix();
//public static final native int kCISamplerFilterLinear();
//public static final native int kCISamplerFilterMode();
//public static final native int kCISamplerFilterNearest();
//public static final native int kCISamplerWrapBlack();
//public static final native int kCISamplerWrapClamp();
//public static final native int kCISamplerWrapMode();
//public static final native int kCISupportedDecoderVersionsKey();
//public static final native int kCIUIParameterSet();
//public static final native int kCIUISetAdvanced();
//public static final native int kCIUISetBasic();
//public static final native int kCIUISetDevelopment();
//public static final native int kCIUISetIntermediate();

/** Functions */
//public static final native double CACurrentMediaTime();
//public static final native CATransform3D CATransform3DConcat(CATransform3D a, CATransform3D b);
//public static final native boolean CATransform3DEqualToTransform(CATransform3D a, CATransform3D b);
//public static final native CGAffineTransform CATransform3DGetAffineTransform(CATransform3D t);
//public static final native CATransform3D CATransform3DInvert(CATransform3D t);
//public static final native boolean CATransform3DIsAffine(CATransform3D t);
//public static final native boolean CATransform3DIsIdentity(CATransform3D t);
//public static final native CATransform3D CATransform3DMakeAffineTransform(CGAffineTransform m);
//public static final native CATransform3D CATransform3DMakeRotation(float angle, float x, float y, float z);
//public static final native CATransform3D CATransform3DMakeScale(float sx, float sy, float sz);
//public static final native CATransform3D CATransform3DMakeTranslation(float tx, float ty, float tz);
//public static final native CATransform3D CATransform3DRotate(CATransform3D t, float angle, float x, float y, float z);
//public static final native CATransform3D CATransform3DScale(CATransform3D t, float sx, float sy, float sz);
//public static final native CATransform3D CATransform3DTranslate(CATransform3D t, float tx, float ty, float tz);

/** Sends */
//public static final native void objc_msgSend_stret(CGAffineTransform result, int id, int sel);
//public static final native int objc_msgSend(int id, int sel, CGAffineTransform arg0);
public static final native int objc_msgSend(int id, int sel, int arg0, CGPoint arg1, CGRect arg2);
public static final native int objc_msgSend(int id, int sel, float arg0);
public static final native int objc_msgSend(int id, int sel, CGRect arg0, int arg1);
public static final native int objc_msgSend(int id, int sel, int arg0, CGRect arg1, CGRect arg2);
//public static final native void objc_msgSend_stret(CATransform3D result, int id, int sel);
public static final native void objc_msgSend_stret(CGPoint result, int id, int sel, CGPoint arg0, int arg1);
public static final native int objc_msgSend(int id, int sel, int arg0, CGRect arg1, int arg2, int arg3);
public static final native int objc_msgSend(int id, int sel, CGPoint arg0);
public static final native int objc_msgSend(int id, int sel, int arg0, CGSize arg1, boolean arg2, int arg3);
public static final native void objc_msgSend_stret(CGPoint result, int id, int sel);
public static final native int objc_msgSend(int id, int sel, float arg0, float arg1, float arg2);
public static final native int objc_msgSend(int id, int sel, int arg0, int arg1, int arg2, float arg3, float arg4);
//public static final native int objc_msgSend(int id, int sel, CGAffineTransform arg0, boolean arg1);
public static final native int objc_msgSend(int id, int sel, int arg0, int arg1, double arg2, int arg3);
public static final native int objc_msgSend(int id, int sel, int arg0, int arg1, CGSize arg2, int arg3, int arg4);
public static final native int objc_msgSend(int id, int sel, boolean arg0);
public static final native double objc_msgSend_fpret(int id, int sel, double arg0, int arg1);
public static final native int objc_msgSend(int id, int sel, CGRect arg0);
public static final native int objc_msgSend(int id, int sel, CGSize arg0, int arg1);
public static final native int objc_msgSend(int id, int sel, int arg0, int arg1, int arg2, int arg3);
public static final native void objc_msgSend_stret(CGRect result, int id, int sel);
public static final native int objc_msgSend(int id, int sel, int arg0, CGRect arg1);
public static final native void objc_msgSend_stret(CGSize result, int id, int sel, int arg0);
public static final native void objc_msgSend_stret(CGSize result, int id, int sel);
public static final native int objc_msgSend(int id, int sel, int arg0);
public static final native int objc_msgSend(int id, int sel, CGSize arg0);
//public static final native int objc_msgSend(int id, int sel, CATransform3D arg0);
public static final native void objc_msgSend_stret(CGRect result, int id, int sel, CGRect arg0, int arg1);
public static final native int objc_msgSend(int id, int sel, int arg0, int arg1, int arg2, CGRect arg3, int arg4, int arg5);
public static final native int objc_msgSend(int id, int sel, int arg0, int arg1, int arg2);
